  ...
  callback = function()
    vim.defer_fn(function()
      local always = {
        ...
        { mode = "n", raw = "<C-h>", desc = "Navigate left (vim/tmux)" },
        { mode = "n", raw = "<C-j>", desc = "Navigate down (vim/tmux)" },
        { mode = "n", raw = "<C-k>", desc = "Navigate up (vim/tmux)" },
        { mode = "n", raw = "<C-l>", desc = "Navigate right (vim/tmux)" },
